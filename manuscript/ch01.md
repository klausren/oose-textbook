...
Fig. 1-1 contrasts the two curves. The spikes in the software curve are each
a change; the rising baseline is accumulated deterioration.
...
faster.* A team with tools but no process is just accelerating in circles.
